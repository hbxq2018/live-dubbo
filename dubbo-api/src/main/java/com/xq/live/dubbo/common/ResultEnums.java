...
public enum ResultEnums {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ResultEnums.class);
    ...
    public static int getCode(String define) {
        try {
            return ResultEnums.valueOf(define).code;
    ...
    public static String getMsg(String define) {
        try {
            return ResultEnums.valueOf(define).msg;
        } catch (IllegalArgumentException e) {
            LOGGER.error("undefined error code: {}", define);
    ...
    public static String getMsg(int code) {
        for (ResultEnums err : ResultEnums.values()) {
            if (err.code == code) {
                return err.msg;
            }
        }
